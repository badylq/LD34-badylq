...
namespace LD34.Scenes
{
	class Death : Scene
	{
		...
		public override void Initialize()
		{
			...
			entity.AddComponent(new Sprite() { DrawOrder = 3, Id = ComponentId.Sprite, Texture = TextureManager.Instance.GetTexture("death"), TextureRect = new Rectangle(0, 0, 640, 360), Height = 720, Width = 1280 });
